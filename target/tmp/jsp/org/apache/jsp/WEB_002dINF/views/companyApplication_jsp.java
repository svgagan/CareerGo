...
public final class companyApplication_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<html>\r\n");
      out.write("<head>\r\n");
      out.write("\t<title>Career Go | Company-Job Application Received Details</title>\r\n");
      out.write("</head>\r\n");
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("function viewApplicant(applicantId){\r\n");
      out.write("\t//alert(applicantId);\r\n");
      out.write("\t$.post(\"updateProfileHits\",{applicantId : applicantId},function(data) \r\n");
      out.write("\t{\r\n");
      out.write("\t\tif(data){\r\n");
      out.write("\t\t\ttoastr.success(\"Viewing Applicant Profile\");\r\n");
      out.write("\t\t\twindow.open(\"applicantProfileInfo?id=\"+applicantId+\"&roleId=\"+1);\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\telse{\r\n");
      out.write("\t\t\ttoastr.warning(\"Profile Not Available\");\r\n");
      out.write("\t\t}\r\n");
      out.write("\t});\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function response(jobId){\r\n");
      out.write("\t$(\"#jobId\").val(jobId);\r\n");
      out.write("\t$(\"#response\").modal();\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function saveResponse(){\r\n");
      out.write("\tvar jobId = $(\"#jobId\").val();\r\n");
      out.write("\tvar message = $(\"#message\").val();\r\n");
      out.write("\t$.post(\"respondToJobApplication\",{jobId : jobId, message : message},function(data) \r\n");
      out.write("\t{\r\n");
      out.write("\t\tif(data){\r\n");
      out.write("\t\t\ttoastr.success(\"Message Sent Successfully\");\r\n");
      out.write("\t\t\twindow.location.reload(true);\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\telse{\r\n");
      out.write("\t\t\ttoastr.warning(\"Message Failed\");\r\n");
      out.write("\t\t}\r\n");
      out.write("\t});\r\n");
      out.write("\r\n");
      out.write("}\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<li class=\"active\"><a href=\"companyApplication?id=");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${register.id}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("&roleId=");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${register.roleId}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      ...
      out.write("        <section class=\"content-header\"><h1>Job Application Received</h1></section>\r\n");
      ...
      out.write("                  <table id=\"jobsApplications\" class=\"table table dataTable\"><!--  table table-bordered table-hover dataTable -->\r\n");
      out.write("                    <thead class=\"no-sort\">\r\n");
      out.write("                      <tr>\r\n");
      out.write("                      \t<th style=\"display:none;width:1%;\">jobId</th>\r\n");
      out.write("                        <th style=\"width:10%;\">Applicant</th>\r\n");
      out.write("                        <th style=\"width:10%;\">Applied On</th>\r\n");
      out.write("                        <th style=\"width:10%;\">Job Title</th>\r\n");
      out.write("                        <th style=\"width:10%;\">Job Location</th>\r\n");
      out.write("                        <th style=\"width:10%;\">Job Type</th>\r\n");
      out.write("                        <th style=\"width:10%;\">Response</th>\r\n");
      ...
      out.write("\r\n");
      out.write("$(function () {\r\n");
      out.write("    $('#jobsApplications').dataTable({\r\n");
      ...
      out.write("    </div>\r\n");
      out.write("    \r\n");
      out.write("    <div id=\"response\" class=\"modal modal-success\">\r\n");
      out.write("       <div class=\"modal-dialog\">\r\n");
      out.write("         <div class=\"modal-content\">\r\n");
      out.write("           <div class=\"modal-header\">\r\n");
      out.write("             <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">×</span></button>\r\n");
      out.write("             <h4 class=\"modal-title\">Job Status Acknowledgment</h4>\r\n");
      out.write("           </div>\r\n");
      out.write("           <div class=\"modal-body\">\r\n");
      out.write("\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" id=\"jobId\" />\r\n");
      out.write("                    <label>Message</label>\r\n");
      out.write("                    <textarea class=\"form-control\" id=\"message\" placeholder=\"Message\"></textarea>\r\n");
      out.write("                 </div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("           <div class=\"modal-footer\">\r\n");
      out.write("           \t<button style=\"margin-left: 10%;\" class=\"btn btn-default\" type=\"button\" onclick=\"saveResponse()\">Send</button>\r\n");
      out.write("             <button type=\"button\" class=\"btn btn-danger \" data-dismiss=\"modal\">Cancel</button>\r\n");
      out.write("           </div>\r\n");
      out.write("         </div><!-- /.modal-content -->\r\n");
      out.write("       </div><!-- /.modal-dialog -->\r\n");
  ...
  private boolean _jspx_meth_c_forEach_0(PageContext _jspx_page_context)
    ...
    _jspx_th_c_forEach_0.setItems((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${ApplicationList}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${jobsList.companyname}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</td>\r\n");
          out.write("\t\t\t\t\t\t\t<td style=\"width:10%;\">");
          ...
          out.write("</td>\r\n");
          out.write("\t\t\t\t\t\t\t<td style=\"width:10%;\">");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${jobsList.companyResponse}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</td>\r\n");
          out.write("\t\t\t\t\t\t\t<td style=\"width:10%;\">\r\n");
          out.write("\t\t\t\t\t\t\t\t<span style=\"cursor: pointer;\" onclick=\"viewApplicant(");
          ...
          out.write(");\" class=\"label label-success\">View Profile</span>\r\n");
          out.write("\t\t\t\t\t\t\t\t<span style=\"cursor: pointer;\" onclick=\"response(");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${jobsList.jobId}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write(");\" class=\"label label-info\">Reply</span>\r\n");
          out.write("\t\t\t\t\t\t\t</td>\r\n");
          out.write("                      \t</tr>\r\n");
          out.write("                      ");
