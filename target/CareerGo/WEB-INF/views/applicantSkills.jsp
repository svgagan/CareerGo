...
<html>
<head>
    	<title>Career Go | Applicant-Skills</title>
</head>

<script type="text/javascript">

function hideSkills(value){
	if(value == 1){
		document.getElementById('viewSkill').style.display = "none";
		document.getElementById('editSkill').style.display = "block";
	}else{
		document.getElementById('viewSkill').style.display = "block";
...
function updateSkills(){
	...
	if(sId == null || sId == '' || sId == "" || sId == " " || sId == ' '){
		sId = 0;
	}
	//alert(sId);
	$.post("updateSkillsDetails",{SID : sId,RID : rId,skills : skills},function(data) 
	{
		if(data.flag){
    ...
    <div class="wrapper">
      ...
      <!-- Left side column. contains the logo and sidebar -->
			...
			<aside class="main-sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li class="active"><a href="applicantSkills?id=${register.id}&roleId=${register.roleId}"><span>Skills</span></a></li>
      ...
      <!-- Content Wrapper. Contains page content -->
       <div class="content-wrapper">
        ...
        <section class="content-header"><h1>Skills</h1></section>
        <!-- Main content -->
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-warning">
                ...
                <!-- form start -->
                <div id="viewSkill" style="display: block;">
                <form role="form">
                  <div class="box-body">
                    <div class="form-group">
                      <label>Skills</label>
                      <textarea class="form-control" id="dSkills" placeholder="Skills" style="width: 100%; height: 20%; font-size: 14px;" disabled>${skills.skills}</textarea>
                      <input type="hidden" id="sID" value="${skills.id}">
                      <input type="hidden" id="rID" value="${register.id}" >
                    </div>
                  </div><!-- /.box-body -->
                  <div class="box-footer">
                    <button type="button" style="float: right;" class="btn btn-info" onclick="hideSkills(1)">Add</button>
                  </div>
                </form>
                </div>
                <div id="editSkill" style="display: none;"> 
		      		<div class="box-body">
                    <div class="form-group">
                      <label>Skills</label>
                      <textarea class="form-control" id="eSkills" placeholder="Skills" style="width: 100%; height: 20%; font-size: 14px;">${skills.skills}</textarea>
                    </div>
                  </div><!-- /.box-body -->
                  <div class="box-footer">
                    <button type="button" style="float: right;margin-left: 2%;" class="btn btn-success" onclick="updateSkills()">Update</button>
                    <button type="button" style="float: right;" class="btn btn-danger" onclick="hideSkills(2)">Cancel</button>
                  </div>
		      	</div>
              </div><!-- /.box -->
			</div>
