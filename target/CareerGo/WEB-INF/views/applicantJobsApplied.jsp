...
<title>Career Go | Applicant-Jobs Applied Details</title>
</head>
...
<body class="hold-transition skin-blue sidebar-mini">
				...
				<ul class="sidebar-menu">
					...
					<li class="treeview active"><a href="#"><span>Jobs</span> <i class="fa fa-angle-left pull-right"></i></a>
						<ul class="treeview-menu">
							...
							<li class="active"><a href="applicantJobApplied?id=${register.id}&roleId=${register.roleId}"><i class="fa fa-circle-o"></i> Jobs Applied</a></li>
	...
	<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header"><h1>Jobs Applied</h1></section>
        <!-- Main content -->
                    ...
                    <tbody id="jobDetails">
                      <c:forEach items="${jobList}" var="jobList">
                      	<tr>
							...
							<td style="width:10%;">${jobList.companyResponse}</td>
                      	</tr>
                      </c:forEach>
                    </tbody>
                  </table>
