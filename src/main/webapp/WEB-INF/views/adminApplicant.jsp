...
<html>
<head>
	<title>Career Go | Admin-Applicant Details</title>
</head>
    ...
    <div class="wrapper">
     ...
     <header class="main-header">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header"><h1>Applicants Details</h1></section>
        <!-- Main content -->
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-info">
                ...
                <!-- form start -->
                <div class="box-body">
                  <table id="applicants" class="table table dataTable"><!--  table table-bordered table-hover dataTable -->
                    <thead class="no-sort">
                      <tr>
                    ...
                    <tbody id="applicantDetails">
                      <c:forEach items="${applicantList}" var="applicantList">
                      	<tr>
                      		<td style="display:none;">${applicantList.id}</td>
							<td>${applicantList.firstname}</td>
							<td>${applicantList.lastname}</td>
							<td>${applicantList.email}</td>
							<td>${applicantList.gender}</td>
							<td>${applicantList.address}</td>
							<td>${applicantList.phone}</td>
							<td>${applicantList.sDate}</td>
							<c:if test="${applicantList.bStatus == false}">
								<td style="cursor: pointer;" title="click to verify" onclick="updateDetails(${applicantList.id});"><span class="label label-warning">${applicantList.vStatus}</span></td>
							</c:if>
							<c:if test="${applicantList.bStatus == true}">
								<td onclick="editApplicant(${applicantList.id});"><span class="label label-success">${applicantList.vStatus}</span></td>
							</c:if>
                      	</tr>
                      </c:forEach>
                    </tbody>
